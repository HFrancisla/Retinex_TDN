#!/usr/bin/env bash
# =============================================================================
# train_lolv2_paired.sh — LOLv2 paired：4 个网络，共 4 次
#
# 使用 .venv 中的 Python 环境，依次执行 4 组 paired 训练。
#
# 用法:
#   bash scripts/train_lolv2_paired.sh                # 直接训练（默认）
#   bash scripts/train_lolv2_paired.sh --validate     # 仅预检: 配置验证 + 冒烟测试
# =============================================================================
...
configs = [
    ...
    ('RetinexPixelClassic    | paired              | LOLv2', 'configs/RetinexPixelClassic/paired/LOLv2_1.0rh_0.3rl_0.001crh_0.001crl_0.1eq_0.1sm.yaml'),
    ('RetinexPixelTrans      | paired              | LOLv2', 'configs/RetinexPixelTrans/paired/LOLv2_1.0rh_0.3rl_0.001crh_0.001crl_0.1eq_0.1sm.yaml'),
    ('RetinexPixelTransMinus | paired              | LOLv2', 'configs/RetinexPixelTransMinus/paired/LOLv2_1.0rh_0.3rl_0.001crh_0.001crl_0.1eq_0.1sm.yaml'),
]
...
# =============================================================================
#  LOLv2 paired — 4 网络 × 1 = 4 次
# =============================================================================
echo ""
echo "  ████████████████████████████████████████████████████████████████████████"
echo "  █  LOLv2 paired：4 个网络，共 4 次训练"
echo "  ████████████████████████████████████████████████████████████████████████"
...
run_exp "RetinexPixelTrans | LOLv2 paired" \
    "configs/RetinexPixelTrans/paired/LOLv2_1.0rh_0.3rl_0.001crh_0.001crl_0.1eq_0.1sm.yaml"

run_exp "RetinexPixelTransMinus | LOLv2 paired" \
    "configs/RetinexPixelTransMinus/paired/LOLv2_1.0rh_0.3rl_0.001crh_0.001crl_0.1eq_0.1sm.yaml"
